...
export class DatabaseStorage implements IStorage {
  ...
  async seedDefaultBeds(): Promise<void> {
    ...
    const bedData: InsertBed[] = [
      { bedNumber: "GW-01", bedName: "General Ward Bed 1", categoryId: "cat-general", wardName: "General Ward (M)", floor: "1st Floor", department: "General", occupancyStatus: "available", isActive: true },
      { bedNumber: "GW-02", bedName: "General Ward Bed 2", categoryId: "cat-general", wardName: "General Ward (M)", floor: "1st Floor", department: "General", occupancyStatus: "available", isActive: true },
      { bedNumber: "GW-03", bedName: "General Ward Bed 3", categoryId: "cat-general", wardName: "General Ward (M)", floor: "1st Floor", department: "General", occupancyStatus: "available", isActive: true },
      { bedNumber: "GW-04", bedName: "General Ward Bed 4", categoryId: "cat-general", wardName: "General Ward (F)", floor: "1st Floor", department: "General", occupancyStatus: "available", isActive: true },
      { bedNumber: "GW-05", bedName: "General Ward Bed 5", categoryId: "cat-general", wardName: "General Ward (F)", floor: "1st Floor", department: "General", occupancyStatus: "available", isActive: true },
      ...
      { bedNumber: "HDU-01", bedName: "Orbit Bed 1", categoryId: "cat-hdu", wardName: "Orbit", floor: "2nd Floor", department: "HDU", occupancyStatus: "available", hasOxygenCapability: true, isActive: true },
      { bedNumber: "HDU-02", bedName: "Orbit Bed 2", categoryId: "cat-hdu", wardName: "Orbit", floor: "2nd Floor", department: "HDU", occupancyStatus: "available", hasOxygenCapability: true, isActive: true },
      { bedNumber: "PVT-01", bedName: "Standard Suite 1", categoryId: "cat-private", wardName: "Standard", floor: "3rd Floor", department: "Private", occupancyStatus: "available", isActive: true },
      { bedNumber: "PVT-02", bedName: "Standard Suite 2", categoryId: "cat-private", wardName: "Standard", floor: "3rd Floor", department: "Private", occupancyStatus: "available", isActive: true },
      { bedNumber: "SP-01", bedName: "Semi Special Room AC 1", categoryId: "cat-semi-private", wardName: "Semi Special Room AC", floor: "2nd Floor", department: "Semi-Private", occupancyStatus: "available", isActive: true },
      { bedNumber: "SP-02", bedName: "Semi Special Room AC 2", categoryId: "cat-semi-private", wardName: "Semi Special Room AC", floor: "2nd Floor", department: "Semi-Private", occupancyStatus: "available", isActive: true },
      { bedNumber: "ISO-01", bedName: "Horizon Room 1", categoryId: "cat-isolation", wardName: "Horizon", floor: "Ground Floor", department: "Isolation", occupancyStatus: "available", isIsolationBed: true, infectionControlFlag: true, ppeProtocolRequired: true, isActive: true },
      { bedNumber: "ISO-02", bedName: "Horizon Room 2", categoryId: "cat-isolation", wardName: "Horizon", floor: "Ground Floor", department: "Isolation", occupancyStatus: "available", isIsolationBed: true, infectionControlFlag: true, ppeProtocolRequired: true, isActive: true },
      { bedNumber: "NOV-01", bedName: "Nova Bed 1", categoryId: "cat-daycare", wardName: "Nova", floor: "1st Floor", department: "Day Care", occupancyStatus: "available", isActive: true },
      { bedNumber: "NOV-02", bedName: "Nova Bed 2", categoryId: "cat-daycare", wardName: "Nova", floor: "1st Floor", department: "Day Care", occupancyStatus: "available", isActive: true },
      { bedNumber: "NEX-01", bedName: "Nexus Bed 1", categoryId: "cat-general", wardName: "Nexus", floor: "3rd Floor", department: "General", occupancyStatus: "available", isActive: true },
      { bedNumber: "NEX-02", bedName: "Nexus Bed 2", categoryId: "cat-general", wardName: "Nexus", floor: "3rd Floor", department: "General", occupancyStatus: "available", isActive: true },
  ...
  async seedDemoPatientData(): Promise<void> {
    ...
    const demoPatients = [
      ...
      { name: "Amit Sharma", age: 45, sex: "Male", bloodGroup: "O+", weight: "80", diagnosis: "Diabetic Ketoacidosis", ward: "Orbit", bed: "HDU-01", department: "Internal Medicine", isIcu: false },
      { name: "Priya Patel", age: 35, sex: "Female", bloodGroup: "AB+", weight: "58", diagnosis: "Post-Operative Care (Appendectomy)", ward: "General Ward (M)", bed: "GW-01", department: "General Surgery", isIcu: false },
