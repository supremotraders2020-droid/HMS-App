...
HMS Core includes 22 core modules, with a strong emphasis on role-based access control for SUPER_ADMIN, ADMIN, DOCTOR, NURSE, OPD_MANAGER, PATIENT, PATHOLOGY_LAB, and MEDICAL_STORE roles.
