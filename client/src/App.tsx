    ...
    <Switch>
      ...
      <Route path="/super-admin">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="dashboard" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
      ...
      <Route path="/super-admin/users">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="users" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/billing">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="billing" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/stock">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="stock" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/surgery">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="surgery" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/medicines">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="medicines" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/insurance">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="insurance" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/claims">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="claims" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/packages">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="packages" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/audit">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="audit" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
      ...
      <Route path="/super-admin/settings">
        {currentUser.role === "SUPER_ADMIN" ? (
          <SuperAdminPortal section="settings" />
        ) : (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold">Access Denied</h2>
            <p className="text-muted-foreground">Only Super Administrators can access this portal.</p>
              ...
              <div className="flex flex-col flex-1 min-w-0">
                <header className="flex items-center justify-between gap-2 px-3 sm:px-4 py-3 border-b glass-panel sticky top-0 z-40 shrink-0">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                    {(currentUser.role === "TECHNICIAN" || currentUser.role === "MEDICAL_STORE" || currentUser.role === "PATHOLOGY_LAB") && (
                      <Button 
                        variant="ghost" 
                        size="icon" 
