...
export default function PatientPortal({ patientName, onLogout }: PatientPortalProps) {
  ...
  const navigationItems = [
    ...
    { id: "notifications", label: "Notifications", icon: Bell, badge: MOCK_NOTIFICATIONS.filter(n => !n.read).length },
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <aside className={`
        fixed lg:static inset-y-0 left-0 z-50 w-72 bg-card border-r transform transition-transform duration-300
        ...
        <ScrollArea className="flex-1">
          <div className="p-4 lg:p-6 space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                  <Card className="hover-elevate">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{appointments.length || 12}</div>
                  ...
                  <Card className="hover-elevate">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{upcomingAppointments.length || 2}</div>
                  ...
                  <Card className="hover-elevate">
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">{MOCK_HEALTH_RECORDS.length}</div>
                    ...
                    <CardContent className="space-y-4">
                      {upcomingAppointments.length > 0 ? (
                        ...
                        <div className="text-center py-8">
                          ...
                          <Button className="mt-4" onClick={() => setActiveSection("opd")}>
                            Book Appointment
                          </Button>
                        </div>
                      )}
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between py-2 border-b">
                          ...
                          <span className="font-medium">Ward A - Room 205</span>
                        </div>
                        <div className="flex justify-between py-2 border-b">
                        ...
                        <div className="flex justify-between py-2 border-b">
                          ...
                          <span className="font-medium">Routine Observation</span>
                        </div>
            ...
            {activeSection === "team" && (
              <div className="space-y-6">
                <div>
                  <h2 className="text-2xl font-bold">Our Medical Team</h2>
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="space-y-2">
                        ...
                        <Input defaultValue={patientName} data-testid="input-name" />
                      </div>
                      <div className="space-y-2">
                        <Label>Email</Label>
                        <Input type="email" defaultValue="patient@email.com" data-testid="input-email" />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input type="date" defaultValue="1990-05-15" data-testid="input-dob" />
                      </div>
                      <div className="space-y-2">
                        <Label>Blood Type</Label>
                        <Select defaultValue="o_positive">
                          <SelectTrigger data-testid="select-blood">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
